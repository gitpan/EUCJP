...
=head1 Escaping Multiple Octet Code (EUCJP software provides)
...
=head1 Escaping Character Classes (EUCJP software provides)
...
=head1 Escaping Built-in Standard Module (EUCJP software provides)
